...
String appId = "65737ffb33aa2e33a0b0b9eb8847e009";
...
String findIcon(String name, bool type) {
  if (type) {
    ...
    switch (name) {
      case "Clouds":
        return "assets/images/weather/sunny_2d.png";
        break;
      case "Rain":
        return "assets/images/weather/rainy_2d.png";
        break;
      case "Drizzle":
        return "assets/images/weather/rainy_2d.png";
        break;
      case "Thunderstorm":
        return "assets/images/weather/thunder_2d.png";
        break;
      case "Snow":
        return "assets/images/weather/snow_2d.png";
        break;
      default:
        return "assets/images/weather/sunny_2d.png";
    }
